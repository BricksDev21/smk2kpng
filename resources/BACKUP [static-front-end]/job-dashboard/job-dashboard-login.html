                ...
                <div class="lg:flex lg:flex-row-reverse lg:flex-wrap gap-0">
                  ...
                  <div class="lg:w-6/12 px-4 md:px-0">
                    <div class="md:p-12 md:mx-6">
                      <form class="flex flex-col gap-6">
                        <div class="mb-6">
                          <p class="mb-6 text-2xl font-bold text-sky-500">Masuk sebagai Perusahaan</p>
                          <div class="mb-6">
                            <label for="job" class="block mb-2 text-sm font-medium text-gray-500 dark:text-gray-300">Username</label>
                            <input type="text" id="job" class="p-4 w-full text-gray-900 bg-gray-200 rounded-xl border-none sm:text-md focus:ring-sky-500 focus:border-sky-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-sky-400 dark:focus:border-sky-400">
                          </div>
                          <div>
                        ...
                        <div class="flex flex-col items-center text-center pt-1 mb-12 pb-1">
                          <button class="inline-block bg-sky-500 px-6 py-4 text-white font-bold text-sm leading-tight rounded-full shadow-xl hover:translate-y-1 hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg transition duration-150 ease-in-out w-full mb-3" type="button">
                            Sign In
                          </button>
                          <a class="text-gray-500" href="#!">Lupa Kata Sandi?</a>
                  ...
                  <div class="relative lg:w-6/12 flex flex-col justify-ar items-center lg:rounded-r-3xl rounded-b-3xl lg:rounded-bl-none bg-gradient-to-b from-sky-400 to-sky-500">
                    ...
                    <div class="text-white px-4 py-6 md:p-12 md:mx-6">
                      ...
                      <p class="text-sm md:text-base font-medium pt-1 lg:pt-6">Belum Punya Akun?
                        <a href="#">
                          <em class="hover:bg-white hover:text-gray-900 pr-1">Daftar Disini</em>
                        </a>
                      </p>
                    </div>
                  </div>
