                ...
                <div class="container flex flex-wrap justify-between items-center mx-auto">
                    ...
                    <div class="hidden w-full md:block md:w-auto" id="navbar-solid-bg">
                        <ul class="flex flex-col mt-4 rounded-lg md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-transparent md:dark:bg-transparent ">
                            ...
                            <li>
                                <a href="{{ route('galeri') }}" class="flex items-center w-full py-2 pr-4 pl-3 text-white rounded hover:bg-gray-700 md:hover:bg-transparent md:border-0 md:hover:text-sky-300 md:p-0 dark:text-gray-900 dark:hover:bg-gray-200 md:dark:hover:text-sky-500 md:dark:hover:bg-transparent text-base" aria-current="page">Galeri</a>
                            </li>
                            <li>
                ...
                @forelse ($pengumuman as $data)
                    <article class="h-full w-full p-9 text-black dark:text-white bg-white rounded-3xl shadow-2xl border-2 border-sky-500 dark:bg-gray-800">
                        <div class="flex items-center justify-between">
                            ...
                            <span class="text-xs font-medium tracking-widest text-gray-500 dark:text-gray-400">{{ \Carbon\Carbon::parse($data->tanggal)->translatedFormat('l, d F Y') }}</span>
                        </div>
